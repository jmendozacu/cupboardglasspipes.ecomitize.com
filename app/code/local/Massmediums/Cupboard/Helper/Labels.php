...
class Massmediums_Cupboard_Helper_Labels extends Mage_Core_Helper_Abstract
{
	/**
	...
	public function getLabels($product)
	{
		...
		$isNew = false;
		if (Mage::getStoreConfig('cupboard/product_labels/new'))
		{	
			$isNew = $this->isNew($product);
		}
		
		$isSale = false;
		if (Mage::getStoreConfig('cupboard/product_labels/sale'))
		{
