...
class Massmediums_Cupboard_Helper_Cssgen extends Mage_Core_Helper_Abstract
{
	/**
	...
	public function __construct()
	{
		...
		$this->_generatedCssPath = 'frontend/cupboard/default/' . $this->_generatedCssFolder;
		$this->_generatedCssDir = Mage::getBaseDir('skin') . '/' . $this->_generatedCssPath;
		$this->_templatePath = 'massmediums/cupboard/css/';
	}
